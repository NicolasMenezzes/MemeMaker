...
export default function Home() {
    ...
    const [selectedTemplate, setSelectedTemplates] = useState(null)
    ...
    return (
        <>
            <Wrapper>
                <img className="logo" src={logo} alt="MemeMaker" />


                <Card>
                    {generatedMeme && (
                        <>
                            <img className="meme" src={generatedMeme} alt="Generated Meme" />
                            <Button type="button" onClick={handleReset}>Criar outro meme!</Button>
                        </>
                    )}
                    {!generatedMeme && (
                        <>
                            <h2>Selecione algum meme</h2>
                            <Templates>
                            ...
                            {selectedTemplate && (
                                <>
                                    ...
                                    <Form onSubmit={handleSubmit}>
                                        ...
                                        <Button type="submit">Faça meu Meme!</Button>
                                    </Form>
                                </>
                            )}
                        </>
